...
- [ ] 1. Foundation — Dependencies, SQLite schema, DAOs, database initialization
  - [ ] 1.1 Add dependencies and create data models
  ...
  - [ ] 1.2 Create SQLite database schema and initialization
  ...
  - [ ] 1.3 Create DAO classes for each entity type
...
- [ ] 2. Connectivity — ConnectivityMonitor and Riverpod provider
  - [ ] 2.1 Implement ConnectivityMonitor
  ...
  - [ ] 2.2 Create ConnectivityMonitor Riverpod provider and ConnectivityNotifier
...
- [ ] 3. Local Caching — CachingRepository implementations
  - [ ] 3.1 Implement CachingExerciseRepository
  ...
  - [ ] 3.2 Implement CachingWorkoutRepository
  ...
  - [ ] 3.3 Implement CachingProfileRepository
  ...
  - [ ] 3.4 Implement CachingProgressRepository
...
- [ ] 4. Checkpoint — Foundation and caching layers
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Sync Engine — SyncQueue, SyncEngine, ConflictResolver
  - [ ] 5.1 Implement SyncQueue service
  ...
  - [ ] 5.2 Implement ConflictResolver
  ...
  - [ ] 5.4 Create SyncEngine Riverpod providers
...
- [ ] 6. Profile Customization — Edit screen, PATCH support, offline-aware updates
  - [ ] 6.1 Create ProfileEditNotifier with client-side validation
  ...
  - [ ] 6.2 Create Profile Edit Screen UI
  ...
  - [ ] 6.3 Add route and navigation for profile edit screen
...
- [ ] 7. Tabbed UI — Exercise library and recommendations tabs
  - [ ] 7.1 Create ExerciseAndRecommendationsScreen with TabBar
  ...
  - [ ] 7.2 Refactor existing exercise list into ExerciseLibraryTab
  ...
  - [ ] 7.3 Create RecommendationsTab with WorkoutScheduler
  ...
  - [ ] 7.4 Update navigation to use tabbed screen
...
- [ ] 8. Workout Scheduler — Weekly schedule widget and visual states
  - [ ] 8.1 Create WorkoutScheduler provider and logic
  ...
  - [ ] 8.2 Create WorkoutSchedulerWidget UI
...
- [ ] 9. Offline UI Indicators — Banner, badge, toast, conflict notifications
  - [ ] 9.1 Create OfflineIndicator banner widget
  ...
  - [ ] 9.2 Create SyncPendingBadge and sync status widgets
  ...
  - [ ] 9.3 Integrate offline indicators into app shell
...
- [ ] 11. Property Tests — All 10 correctness properties from the design
  ...
  - [ ]* 11.2 Write property test: Offline mutations reflected in local cache
  ...
  - [ ]* 11.4 Write property test: Conflict resolution deterministic last-write-wins
...
- [ ] 12. Integration — Wire caching repositories into providers, pull-to-refresh, end-to-end
  - [ ] 12.1 Replace remote repository providers with caching providers
